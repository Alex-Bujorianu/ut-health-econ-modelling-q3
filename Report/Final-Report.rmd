...
We analyze the available dataset in order to determine in order to define parameters and distributions for various attributes of the patients.
...
## Differences between the experiemental and standard model
