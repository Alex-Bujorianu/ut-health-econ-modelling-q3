...
We code some helper functions for the simulation model to help it assign attributes to the patients or determine the event to happen.

Based on the previous analysis, we code functions to define the sex
