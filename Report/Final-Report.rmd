...
Next, we determine threshold values for the three tests, above which the patient is expected to respond to the current treatment. We determine 0.8 to be the threshold values for all the three tests.
...
## Differences betweenn PSA and BCA
