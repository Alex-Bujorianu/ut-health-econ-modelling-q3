...
Most of the points (representing a simulation run) will fall below a WTP threshold of €50,000. Beyond that the curve flattens off. For a more plausible WTP of €20,000 (used in the Netherlands) about 60% of the values will be below it.
